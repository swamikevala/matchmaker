...
public class SoftTFIDF extends TFIDF implements Comparator
{
	...
	//Constructor added for matchmaker
	public SoftTFIDF(JsonObject params) {
		super();
		JsonObject jTokenDistance = params.get("token-comparator-class").getAsJsonObject();
		tokenDistance = (StringDistance) ConfigLoader.getInstance(jTokenDistance);
		tokenMatchThreshold = params.get("token-threshold").getAsDouble();
	}
